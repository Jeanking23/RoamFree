                ...
                {currentStep === 4 && (
                    <div>
                        <CardHeader className="p-0 text-center md:text-left">
                         ...
                         <CardContent className="p-0 pt-8">
                             <FormItem>
                                <FormLabel><div className="flex items-center gap-2"><UploadCloud className="h-5 w-5 text-primary"/>Photos</div></FormLabel>
