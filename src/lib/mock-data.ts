...
export const allMockStays: MockStay[] = [
  {
    ...
    photos: [
      ...
      { id: "p2s1", src: "https://images.unsplash.com/photo-1634045634161-b842d46ed840?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3NDE5ODJ8MHwxfHNlYXJjaHw0fHxpbmZpbml0eSUyMHBvb2x8ZW58MHx8fHwxNzU3MzU1ODc1fDA&ixlib=rb-4.1.0&q=80&w=1080", alt: "Infinity pool Bali", dataAiHint: "infinity pool" },
      { id: "p3s1", src: "https://images.unsplash.com/photo-1638282504303-46f10708366b?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3NDE5ODJ8MHwxfHNlYXJjaHw5fHxsdXh1cnklMjBiZWRyb29tfGVufDB8fHx8MTc1NzM1NTg3Nnww&ixlib=rb-4.1.0&q=80&w=1080", alt: "Master bedroom Bali", dataAiHint: "luxury bedroom" },
      { id: "p4s1", src: "https://images.unsplash.com/photo-1642632015727-e728fff2d0c1?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3NDE5ODJ8MHwxfHNlYXJjaHwyfHxtb2Rlcm4lMjBsaXZpbmd8ZW58MHx8fHwxNzU3MjQ3OTQwfDA&ixlib=rb-4.1.0&q=80&w=1080", alt: "Living area Bali", dataAiHint: "modern living" },
    ],
  ...
  },
  {
    ...
    amenities: ["Hot Tub", "Fireplace", "WiFi", "Kitchenette", "Ski-in/Ski-out Access (nearby)"],
     photos: [
      ...
      { id: "p2s2", src: "https://images.unsplash.com/photo-1697807713050-b0e7d00956a2?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3NDE5ODJ8MHwxfHNlYXJjaHw4fHxjYWJpbiUyMGZpcmVwbGFjZXxlbnwwfHx8fDE3NTI3Mjg0MjR8MA&ixlib=rb-4.1.0&q=80&w=1080", alt: "Cozy cabin interior with fireplace", dataAiHint: "cabin fireplace" },
    ],
