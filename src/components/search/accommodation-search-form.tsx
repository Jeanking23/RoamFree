...
export default function AccommodationSearchForm({ onSearch, isResultsPage = false }: AccommodationSearchFormProps) {
  ...
  return (
    <Form {...form}>
      <form onSubmit={form.handleSubmit(onSubmit)} className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-4 items-end p-0 bg-card rounded-lg">
        {/* Destination */}
        <FormField
        ...
        <div className="grid grid-cols-2 gap-4 items-center pt-2 col-span-1 md:col-span-2 lg:col-span-2 lg:pt-8">
