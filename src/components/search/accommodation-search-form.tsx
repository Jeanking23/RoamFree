            ...
            <FormItem className="col-span-12 md:col-span-3">
              ...
              <FormControl>
                <Input
                  ...
                  {...field}
                  value={field.value || ''}
                  className={cn(!isResultsPage && "bg-background/20 text-white placeholder:text-white/70 border-white/50 focus-visible:ring-white/50")}
                />
              </FormControl>
              <FormMessage />
            </FormItem>
                  ...
                  <FormControl>
                    <Button
                      ...
                      className={cn(
                        ...
                        !isResultsPage && "bg-background/20 text-white hover:text-white border-white/50"
                      )}
                    >
        ...
        <div className="col-span-12 grid grid-cols-2 md:grid-cols-4 gap-4 pt-2">
            <FormField control={form.control} name="propertyType" render={({ field }) => ( <FormItem>
                ...
                <Select onValueChange={field.onChange} defaultValue={field.value}>
                    <FormControl>
                        <SelectTrigger className={cn(!isResultsPage && "bg-background/20 text-white border-white/50")}>
                            <SelectValue/>
                        </SelectTrigger>
                    </FormControl>
                    <SelectContent>
